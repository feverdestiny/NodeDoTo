            ...
            (function () {
                ...
                s = function (e, f, n, t) {
                    ...
                    if (n = e.match(/rgb\(\s*(\-?\d+),\s*(\-?\d+)\s*,\s*(\-?\d+)\s*\)/)) {
                        ...
                        t[3] = 1
                    } else if (n = e.match(/rgba\(\s*(\-?\d+),\s*(\-?\d+)\s*,\s*(\-?\d+)\s*,\s*([01]|[01]?\.\d+)\)/))for (t = n.slice(1, 5), f = o = 0; 3 >= o; f = ++o)t[f] = +t[f]; else if (n = e.match(/rgb\(\s*(\-?\d+(?:\.\d+)?)%,\s*(\-?\d+(?:\.\d+)?)%\s*,\s*(\-?\d+(?:\.\d+)?)%\s*\)/)) {
                    ...
                    if (s = z(arguments), n = s[0], c = s[1], a = s[2], 0 === c)o = f = e = 255 * a; else {
                    ...
                    if (d = z(arguments), n = d[0], u = d[1], i = d[2], i *= 255, 0 === u)c = f = e = i; else switch (360 === n && (n = 0), n > 360 && (n -= 360), 0 > n && (n += 360), n /= 60, t = Math.floor(n), r = n - t, a = i * (1 - u), o = i * (1 - u * r), l = i * (1 - u * (1 - r)), t) {
                        case 0:
                    ...
                    return y = "rgb", v = s("#ccc"), x = 0, g = !1, h = [0, 1], d = [], _ = !1, k = [], m = 0, p = 1, b = !1, w = 0, i = {}, c = function (e, r) {
                        ...
                        if (null == e && (e = ["#ddd", "#222"]), null != e && "string" === U(e) && null != (null != (c = s.brewer) ? c[e] : void 0) && (e = s.brewer[e]), "array" === U(e)) {
                            ...
                            if (null != r)k = r; else for (k = [], f = a = 0, l = e.length - 1; l >= 0 ? l >= a : a >= l; f = l >= 0 ? ++a : --a)k.push(f / (e.length - 1))
                        }
                        return o(), d = e
                    }, u = function (e) {
                        ...
                        if (r ? b = e : h.length > 2 ? (f = t(e), b = f / (w - 1)) : (b = a = m !== p ? (e - m) / (p - m) : 0, b = a = (e - m) / (p - m), b = Math.min(1, Math.max(0, b))), r || (b = l(b)), c = Math.floor(1e4 * b), i[c])n = i[c]; else {
                        ...
                        var f, t, a, o, c, u;
                        if (null == r && (r = "hex"), e = [], t = [], h.length > 2)for (f = a = 1, u = h.length; u >= 1 ? u > a : a > u; f = u >= 1 ? ++a : --a)t.push(.5 * (h[f - 1] + h[f])); else t = h;
                    ...
                    if (a = {
                        ...
                        }, "array" === U(e))for (u = 0, l = e.length; l > u; u++)o = e[u], c(o); else for (t in e)o = e[t], c(o, t);
